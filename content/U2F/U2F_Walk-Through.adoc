...
=== PAM Plugin
The PAM plugin requires Yubico U2F link:/libu2f-host[libu2f-host-dev] and link:/libu2f-server[libu2f-server-dev] libraries.
...
* PAM – Yubico-provided link:/pam-u2f/[pam-u2f]
...
* Python – link:/u2fval-client-python/[u2fval-client-python]
* PHP – link:/u2fval-client-php/[u2fval-client-php]
...
All Yubico devices attestation certificates are signed by the Yubico link:/U2F/yubico-u2f-ca-certs.txt[root CA].

Yubico devices provide additional link:/U2F/yubico-metadata.json[device information] in the mapping attestation certificate. This is used by several of the link:/Software_Projects/[WebAuthn libraries].See link:/U2F/Attestation_and_Metadata/[Attestation and metadata].
...
=== Module Validation
Submit your module to YubiKey OTP Validation Server, link:/yubikey-val/[https:..developers.yubico.com/yubikey-val].
