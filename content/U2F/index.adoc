...
NOTE: U2F is a very new protocol and is currently only supported natively by Google Chrome. For firefox, there is a plugin located [here](https://addons.mozilla.org/en-US/firefox/addon/u2f-support-add-on/).
