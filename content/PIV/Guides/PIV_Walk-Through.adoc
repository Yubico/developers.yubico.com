...
Use this tool for managing the PIV application on a YubiKey. For more information, see link:/yubico-piv-tool/[the Yubico PIV Tool page].

The Yubico PIV tool is available link:/yubico-piv-tool/Releases/[on Yubico's release page for it] or on link:https://github.com/Yubico/yubico-piv-tool/[GitHub].
...
For SSH on PKCS#11, configure public key authentication with link:/PIV/Guides/SSH_with_PIV_and_PKCS11.html[OpenSSH through PKCS#11], which provides examples for macOS and Linux systems.
...
* link:/PIV/Tools.html[Supported PIV Configuration Tools], which include the YubiKey Manager and the Yubico PIV Tool.
