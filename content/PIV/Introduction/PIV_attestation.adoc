...
NOTE: If you have a YubiKey Preview device, the pre-loaded attestation certificate will instead be signed by a link:piv-preview-ca-cert.pem[Yubico Preview CA].
