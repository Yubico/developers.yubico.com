...
Note for the Form Factor OID, it will match the values for form factor listed in the link:/yubikey-manager/Config_Reference.html[Configuration Reference].
