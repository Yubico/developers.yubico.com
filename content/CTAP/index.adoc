...
Yubico offers several libraries and SDKs for developers. For a complete list, please see our link:/Software_Projects/[Software Projects].

* For building a web application using WebAuthn, there is link:/java-webauthn-server/[java-webauthn-server], and link:https://github.com/Yubico/python-fido2[python-fido2].
...
* For mobile development, see our link:/yubikit-ios/[yubikit-ios], link:/yubikit-android/[yubikit-android].
