...
This guide covers CTAP 2.2 features from an implementation perspective, with specific guidance for Yubico SDKs. Many features operate at the native application layer—check our link:/WebAuthn/WebAuthn_Browser_Support/[browser support matrix] for WebAuthn API availability.
...
[NOTE]
====
*Browser Support Required*: Secure Payment Confirmation requires coordinated browser support. Check our link:/WebAuthn/WebAuthn_Browser_Support/[browser support matrix] before implementing SPC workflows, as browser adoption is still evolving.
====
...
* link:/WebAuthn/Concepts/PRF_Extension/[PRF Extension Overview]
* link:/WebAuthn/Concepts/PRF_Extension/Developers_Guide_to_PRF.html[Developer's Guide to PRF]
* link:/WebAuthn/Concepts/PRF_Extension/CTAP2_HMAC_Secret_Deep_Dive.html[CTAP2 HMAC-Secret Deep Dive]
====
...
* link:/WebAuthn/WebAuthn_Browser_Support/[WebAuthn Browser Support Matrix]
