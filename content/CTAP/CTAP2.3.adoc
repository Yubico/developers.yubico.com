...
[NOTE]
====
*WebAuthn and Browser Support*: While CTAP 2.3 features are available at the protocol level, WebAuthn applications depend on browser support for these capabilities. Consult our link:/WebAuthn/WebAuthn_Browser_Support/[WebAuthn Browser Support] page before implementation.
====
