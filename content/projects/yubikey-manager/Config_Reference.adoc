...
When creating a custom YubiKey configuration software in the python language, use the ykman source code as a guide for reading and writing configurations. If you’d rather integrate with c libraries:

* link:https://github.com/Yubico/libfido2[Libfido2] communicates with the FIDO2 and U2F Applications
* link:https://github.com/Yubico/yubico-piv-tool/blob/master/lib/ykpiv.h[Ykpiv] communicates with the PIV and OpenPGP Applications
* link:https://github.com/Yubico/yubikey-personalization[Ykpers] communicates with the OTP and OATH Applications
