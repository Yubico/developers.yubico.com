...
FIPS YubiKeys with firmware 5.4.X and above will have the high bit flipped as well.
...
|UNDEFINED |0x00 |N/A
|Keychain with USB-A |0x01 |0x81
|Nano with USB-A |0x02 |0x82
|Keychain with USB-C |0x03 |0x83
|Nano with USB-C |0x04 |0x84
|Keychain with Lightning and USB-C |0x05 |0x85
|===
