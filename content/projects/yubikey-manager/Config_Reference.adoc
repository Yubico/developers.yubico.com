...
[1] _Note: YubiHSM 2 has the concept of a link:/YubiHSM2/Concepts/Capability.html[Capability] which differs from this definition._
...
Yubico provides link:/yubikey-manager/[ykman] which can be used both as a command line configuration tool, and as a python library to interact with the YubiKey.
