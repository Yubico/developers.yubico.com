...
This tool can configure a link:/OTP/[Yubico OTP] credential, a static password, a challenge-response credential or an link:/OATH/[OATH] HOTP credential in both of these slots.
...
==== Windows and macOS
Installers are available link:/yubikey-manager-qt/Releases/[here].
...
===== AppImage
AppImage is available link:/yubikey-manager-qt/Releases/[here].

==== Source
To install from source, see the link:doc/development.adoc[development] instructions.

=== Command line version
This project also bundles the link:/yubikey-manager/[command line version].
