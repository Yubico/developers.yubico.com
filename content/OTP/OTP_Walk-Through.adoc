...
* **OTP Generation:** The YubiKey generates an OTP when a user requests to log in. This OTP is sent to the verification server (YubiCloud or a link:/Software_Projects/Yubico_OTP/YubiCloud_Validation_Servers/[self-hosted server]).
...
. **Verification server:** YubiCloud or a link:/Software_Projects/Yubico_OTP/YubiCloud_Validation_Servers/[self-hosted server]
...
* Use the link:/OTP/Specifications/OTP_validation_protocol.html[Yubico OTP Validation Protocol Version 2.0] to construct and verify signatures.
...
**  link:/OTP/Modhex_Converter.html[Modhex Converter]

=== Deprecated Libraries
The following are deprecated and archived:

* link:/php-yubico/[PHP]
* link:/yubico-dotnet-client/[DotNET]
* link:/yubico-java-client/[Java]
* link:/yubico-c-client/[C]
* link:/yubico-perl-client/[Perl]
* link:/windows-apis/[Windows]
