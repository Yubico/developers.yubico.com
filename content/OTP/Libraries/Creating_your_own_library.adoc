 ...
 * link:/yubikey-val/GettingStartedWritingClients.html[Getting started writing clients]
 * link:/yubikey-val/ValidationProtocolV20.html[Validation protocol specification]
