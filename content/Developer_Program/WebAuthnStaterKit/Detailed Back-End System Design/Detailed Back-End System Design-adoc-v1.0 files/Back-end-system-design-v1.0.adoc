...
image::back1-congnito-user-pool-lambda-triggers-v1.png[]
*Figure 1 - Cognito User Pool Lamba Triggers*
...
image::back2-pre-sign-up-v1.png[]
*Figure 2 - Pre sign-up*
...
*Figure 3 - Define Auth Challenge Received through Cognito*
...
*Figure 4 - Define Auth Challenge Returned*
...
image::back4-create-auth-challenge-v1.png[]
*Figure 5 - Create Auth Challenge Received*
...
image::back4-create-auth-challenge-v1.png[]
*Figure 6 - Create Auth Challenge Response from Client*
...
image::back5-verify-auth-challenge-v1.png[]
*Figure 7 - Verify Auth Challenge Response from Client*
...
image::back5-verify-auth-challenge-v1.png[]
*Figure 8 - Verify Auth Challenge Response Returned*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 9 - Define Auth Challenge Received from Verify Challenge*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 10 - Define Auth Challenge Returned from User*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 11 - Define Auth Challenge Received from Client*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 12 - Define Auth Challenge Returned*
...
image::back4-create-auth-challenge-v1.png[]
*Figure 13 - Create Auth Challenge Received*
...
image::back4-create-auth-challenge-v1.png[]
*Figure 14 - Create Auth Challenge Response from Client*
...
image::back5-verify-auth-challenge-v1.png[]
*Figure 15 - Verify Auth Challenge Response from Client*
...
image::back5-verify-auth-challenge-v1.png[]
*Figure 16 - Verify Auth Challenge Returned*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 17 - Define Auth Challenge Received*
...
image::back3-define-auth-challenge-v1.png[]
*Figure 18 - Define Auth Challenge Returned to User*
