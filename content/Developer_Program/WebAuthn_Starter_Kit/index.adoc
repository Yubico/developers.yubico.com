...
* link:https://developers.yubico.com/Developer_Program/WebAuthn_Starter_Kit/Account_and_Lifecycle_Management/Account_and_Lifecycle_Management.html[User Account and Lifecycle Management]
