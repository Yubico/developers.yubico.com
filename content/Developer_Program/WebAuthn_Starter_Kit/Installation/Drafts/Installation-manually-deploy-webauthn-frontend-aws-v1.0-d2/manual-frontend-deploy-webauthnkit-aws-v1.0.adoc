...
image::mfront1-select-cloudformation-stack-v1.jpg[]
...
image::mfront2-view-cloudformation-stack-details-v1.jpg[]
*Figure 2 - View CloudFormation Stack details*

*Step 1.3.* Select the option `Outputs`.

image::mfront3-cloudformation-stack-output-aws-v1.jpg[]
...
image::mfront4-cloudformation-stack-output-aws-v1.jpg[]
...
image::mfront5-amazon-s3-bucket-aws-console-v1.jpg[]
...
image::mfront7-access-webauthnkit-react-webapp-aws-amplify-v1.jpg[]
...
image::mfront8-check-react-webapp-aws-amplify-v1.jpg[]
...
image::mfront9-change-env-variables-aws-v1.jpg[]
...
image::mfront10-access-webauthnkit-react-run-locally-v1.jpg[]
