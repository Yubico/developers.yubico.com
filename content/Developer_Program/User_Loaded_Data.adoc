...
With resident keys, the FIDO2 Application can hold 20 private credentials which can include information about the associated user account, including login name. Any data accepted by the FIDO2 Application will be defined in the W3C Web Authentication specification.
