...
link:/Developer_Program/Guides/Securing_Web_Services_with_WebAuthn.adoc[I want to use FIDO2 to secure my Web service]
...
link:/Developer_Program/Guides/Securing_Web_Services_with_OTP.adoc[I want to use OTPs to secure my Web service]
...
link:/yubico-piv-tool/YKCS11/[I want to use Smart Cards to secure my Web service]
