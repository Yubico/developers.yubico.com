...
All YubiKeys, with the exception of the Security Key by Yubico (SKY) series supports multiple OTP protocols - link:/OTP/OTPs_Explained.html[Yubico OTP], link:/OATH/[OATH-HOTP and OATH-TOTP]. These OTPs can be provided by the YubiKey via two methods:

* link:/Developer_Program/Guides/Touch_triggered_OTP.adoc[A touch-triggered output of the OTP sent via a series of keystrokes from a virtual keyboard]
* link:/OATH/YubiKey_OATH_software.html[An application similar to Google Authenticator where the OTPs are generated on the YubiKey and presented on the local device.]
...
* link:/Developer_Program/Guides/Touch_triggered_OTP.adoc[Introduction to Yubico OTP]
* link:/OTP/OTPs_Explained.html[Yubico OTPs Explained]
* link:/OTP/Specifications/OTP_validation_protocol.html[Yubico OTP Validation Protocol]
* link:/OTP/Specifications/OTP_decryption_protocol.html[Yubico OTP Decryption Protocol]
...
link:/Software_Projects/[YubiKey configuration tools] can be used to load Yubico OTP secrets on a YubiKey, via a scripted CLI, using the low level libraries or through a GUI Application.

*Yubico OTP Supporting Interfaces:*

* link:/Developer_Program/Guides/Touch_triggered_OTP.adoc[Touch-Triggered OTPs]
...
* link:/OTP/Plugins.html[Yubico OTP Clients]
* link:/yubikey-val/Getting_Started_Writing_Clients.html[Getting Started Writing Clients]
* link:/OTP/Guides/Self-hosted_OTP_validation.html[Self-hosted OTP validation]
...
* link:/Developer_Program/Guides/Touch_triggered_OTP.adoc[Touch-Triggered OTPs]
* link:/OATH/YubiKey_OATH_software.html[YubiKey OATH software]
* link:/OATH/YKOATH_Protocol.html[YubiKey OATH protocol]
