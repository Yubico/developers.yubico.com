...
If you develop in WSL2 on Windows, follow the link:/SSH/Securing_SSH_and_git_with_FIDO2_on_WSL2.html[WSL2 guide], which connects WSL2's OpenSSH to the FIDO components that ship with Windows.
