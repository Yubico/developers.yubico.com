...
NOTE: Developing in WSL2? See link:/SSH/Securing_SSH_and_git_with_FIDO2_on_WSL2.html[Securing SSH and Git Commit Signing with FIDO2 on WSL2], which covers SSH authentication and commit signing from WSL2 end to end.
