...
* PKCS11: Security update for https://www.yubico.com/support/security-advisories/ysa-2023-01/[YSA-2023-01]* PKCS11: Allow only a user with access to all the object's domains to edit its attributes
