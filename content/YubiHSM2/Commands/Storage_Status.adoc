...
R~total~ := Total number of records, two bytes

R~free~ := Currently free storage records, two bytes

P~total~ := Total number of pages, two bytes

P~free~ := Currently free storage pages, two bytes

S := Page size in bytes, two bytes
