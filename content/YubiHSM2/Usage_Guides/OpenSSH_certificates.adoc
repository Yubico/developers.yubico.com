...
Instead of directly signing a user's SSH pubkey directly, the YubiHSM
...
A hex-dump example of a template file is shown below, containing:
...
To illustrate what happens when the constrains specified in the
