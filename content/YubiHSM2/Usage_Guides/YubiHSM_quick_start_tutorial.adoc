...
Note how the command above has two distinct sets of Capabilities. This is because Authekys Object also have link:../Concepts/Capability.adoc[Delegated Capabilities].
