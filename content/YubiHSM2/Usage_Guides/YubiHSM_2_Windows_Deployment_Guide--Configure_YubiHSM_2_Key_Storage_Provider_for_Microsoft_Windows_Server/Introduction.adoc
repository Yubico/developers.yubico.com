...
- link:https://docs.yubico.com/software/yubihsm-2/hsm-2-user-guide/hsm2-ksp-windows-server-guide.html[YubiHSM 2 with Key Storage Provider for Windows Server]
