...
X509Certificates are stored undet the same ObjectID on the YubiHSM 2. To do so, follow the instruction under the section
...
deactive and re-activate the Crypto Token before the new keys are ready to be used), or use EJBCA Adminweb to create
