...
It would be worthwhile to peruse the link:https://www.gnupg.org/documentation/[GnuPG documentation],
especially the parts on the usage and setting of the PIN and reset codes.
