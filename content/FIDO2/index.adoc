...
Privacy Protection:: A FIDO2 authenticator generates a new pair of keys for every service, and only the service stores the public key. With this approach, no secrets are shared between service providers.
