...
We are going to walk through link:https://github.com/Yubico/java-webauthn-server/tree/master/webauthn-server-demo[Yubico's Java WebAuthn Server library demo] registration and authentication ceremonies and explain how the WebAuthn interaction works, step by step.
...
If you get stuck, you can check link:https://stackoverflow.com[Stack Overflow]. If you don't recieve and answer, or remain stuck, please file an issue or open a support ticket and we'll help you out.
