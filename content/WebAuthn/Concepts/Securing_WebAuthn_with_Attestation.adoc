...
+
You can find the root certificates used to sign attestations on manufacturer websites (Yubico’s is link:/U2F/yubico-u2f-ca-certs.txt[here]) or in the link:https://fidoalliance.org/metadata/[FIDO metadata service version 3].
