...
Client hints are optional values sent by the relying party (RP) to help the browser decide which authenticators to show first in the UI. They help improve the user experience during passkey flows. Support for client hints varies by browser and platform.
...
| Chrome
| ✅ Fully supported
| Supported starting in *Chromium 128+* on Android, ChromeOS, macOS, Ubuntu, and Windows.

| Edge
| ✅ Fully supported
| Supported starting in *Edge 128+* on Android, macOS, Ubuntu, and Windows.

| Safari
| ❌ Not supported
| Not supported on macOS or iOS.
