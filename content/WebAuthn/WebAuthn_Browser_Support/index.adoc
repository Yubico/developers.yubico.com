...
Note:
Client hints support varies widely between platforms and browsers. On some platforms (like Windows and Android), hints may be parsed but do not affect the authenticator selection UI.
