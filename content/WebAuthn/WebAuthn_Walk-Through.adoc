...
TIP: This walk through is designed for people who prefer to *learn by doing*. If you prefer learning concepts from the ground up, check out our link:/WebAuthn/WebAuthn_Developer_Guide/[WebAuthn Developer Guide]. This walk-through and the guide are complementary to each other.
...
public class WebAuthnServer {
    ...
    // The InMemoryRegistrationStorage implements RegistrationStorage and CredentialRepository interfaces
