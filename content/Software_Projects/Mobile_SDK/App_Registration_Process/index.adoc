...
Download the https://github.com/Yubico/yubikit-ios[SDK.zip] file for a list of free-to-use example assets for use in your YubiKey-enabled iOS application. Under the extracted folder: 
