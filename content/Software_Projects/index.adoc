...
| Library | link:/yubikit-android/[Yubico Mobile Android SDK (yubikit-android)] | Software development in Java (e.g. for Android) | link:/Mobile/Android/[Getting Started Guide]
...
* link:./Resources.html[**Key Integration Guides & Software Resources**] -- Learn how to use our software with key technologies like Passkeys, PIV, and mobile apps.
* link:./Support.html[**Yubico Product Support**] -- Find the right support channel for your specific product or question.
