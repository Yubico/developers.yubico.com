...
[options="header", cols="15%,30%,35%,20%a"]
|===
h| Software Type
h| Product Name
...
| Application
| link:https://developers.yubico.com/yubioath-flutter/[Yubico Authenticator for Android/Desktop]
...
| Tool
| link:https://developers.yubico.com/yubikey-manager/[YubiKey Manager (``ykman``)]
...
| Tool
| link:https://developers.yubico.com/yubikey-manager/https://www.yubico.com/products/yubienroll/[YubiEnroll]
...
| Tool
| link:https://developers.yubico.com/yubico-piv-tool[Yubico PIV Tool (``yubico-piv-tool``)]
| Command-line tool and library for using and managing the Personal Identity Verification (PIV) functionality on YubiKeys.
| link:https://developers.yubico.com/yubico-piv-tool/Manuals/yubico-piv-tool.1.html[Manual]

| Library
| link:https://developers.yubico.com/java-webauthn-server/[``java-webauthn-server`` (Yubico WebAuthn Server)]
| Java library for building FIDO2/WebAuthn server-side authentication (FIDO relying party development).
| link:https://developers.yubico.com/java-webauthn-server/[Configuration Guide and JavaDocs]
...
| Library
| link:https://github.com/Yubico/yubikit-android[``yubikit-android``]
...
| Library
| link:https://github.com/Yubico/yubikit-ios[``yubikit-ios``]
...
| Library
| link:https://developers.yubico.com/python-fido2/[``python-fido2``]
...
| Library
| link:https://developers.yubico.com/libfido2/[``libfido2``]
| C library for FIDO2/WebAuthn client-side operations.
| link:https://developers.yubico.com/libfido2/Manuals/[Manuals]

| Library
| link:https://developers.yubico.com/pam-u2f/[``pam-u2f``]
| Pluggable Authentication Module (PAM) for Linux, enabling FIDO U2F or FIDO2 authentication for login and sudo.
| link:https://developers.yubico.com/pam-u2f/Manuals/[Manuals]
...
| Tool
| link:https://developers.yubico.com/yubihsm-shell/yubihsm-shell.html[``yubihsm-shell``]
...
| Tool
| https://developers.yubico.com/yubihsm-setup/[``yubihsm-setup``]
...
| Library
| https://developers.yubico.com/python-yubihsm/[``python-yubihsm``]
| Python library for communicating with and managing a YubiHSM 2.
| link:https://developers.yubico.com/python-yubihsm/API_Documentation/[API Documentation]

| Library
| link:https://developers.yubico.com/yubihsmrs/[``yubihsmrs``]
| Rust library (crate) for interacting with a YubiHSM 2.
| link:https://developers.yubico.com/yubihsmrs/[Manual]
|===
...
For detailed instructions on how to verify signatures and to obtain Yubico's public OpenPGP keys, please visit our link:https://www.yubico.com/support/security-advisories/software-signing/[Software Signing page].
...
* **Identify Your YubiKey**: Need help identifying your YubiKey model? Use our guide: link:https://www.yubico.com/support/getting-started/yubikey-basics/identifying-your-yubikey/[Identifying your YubiKey].
* **YubiCloud REST API**: Information on the link:https://developers.yubico.com/YubiCloud/API_Reference/[YubiCloud Validation Protocol and REST API].
* **Passkey Integration Guide**: Learn how to implement passkeys with Yubico solutions: link:./[Passkey Integration Guide].
* **Using YubiKeys in Your Mobile App**: Best practices for mobile integration: link:./[Using YubiKeys in Your Mobile App Guide].
* **Securing SSH with the YubiKey**: Guide to enhancing SSH security: link:./[Securing SSH with the YubiKey].
...
* link:https://www.yubico.com/support/terms-conditions/end-of-life-policy/[Yubico End-of-Life Policy]
* link:https://www.yubico.com/support/eol/[Yubico End-of-Sale / End-of-Life Products]
