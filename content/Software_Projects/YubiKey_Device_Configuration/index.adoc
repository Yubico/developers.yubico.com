...
=== YubiKey
Configuration of standard YubiKey features, including YubiKey OTP, OATH, Challenge-Response and Static Password.

GUI tool:: link:/yubikey-personalization-gui/[yubikey-personalization-gui]
C library:: link:/yubikey-personalization/[yubikey-personalization]
