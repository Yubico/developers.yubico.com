...
NOTE: For developers currently supporting FIDO2 security keys using the WebAuthn standard on desktop browsers, checkout this guide link:/WebAuthn/Supporting_FIDO2_Security_Keys_on_iOS_or_iPadOS/[Supporting FIDO2 Security Keys on iOS and iPadOS]
